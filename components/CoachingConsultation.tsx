...
interface CoachingConsultationScreen {
  id: number;
  fullname: string;
  job_title: string;
  experience: number;
...
const CoachingConsultationScreenCard = ({
  consultation,
}: {
  consultation: CoachingConsultationScreen;
}) => {
    ...
    <View style={tailwind("bg-white rounded-lg shadow-lg p-4 mb-4")}>
      ...
      <View style={tailwind("mt-6")}>
        ...
        <View style={tailwind("flex-row justify-between items-center mt-4")}>
          <Text style={tailwind("text-lg font-bold")}>From R650.00</Text>
          <TouchableOpacity
...
export default CoachingConsultationScreenCard;
