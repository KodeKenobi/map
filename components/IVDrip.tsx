...
const IVDripScreenCard = ({ consultation }: { consultation: IVDripScreen }) => {
  ...
  return (
    <View style={tailwind("bg-white rounded-lg shadow-lg p-4 mb-4")}>
      <TouchableOpacity onPress={() => setModalVisible(true)}>
        <Image
          source={require("../assets/images/iv-drip.jpeg")}
          style={[tailwind("w-full rounded-lg"), { height: 200 }]}
          resizeMode="cover"
        />
      </TouchableOpacity>
      <View style={tailwind("mt-6")}>
        <Text style={[tailwind("text-xl font-bold mb-2")]}>IV Drip</Text>
        ...
        <View style={tailwind("flex-row justify-between items-center mt-4")}>
          <Text style={tailwind("text-lg font-bold")}>From R400.00</Text>
          <TouchableOpacity
...
export default IVDripScreenCard;
